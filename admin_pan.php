  ...
  <header>
    ...
    <div class="side-bar">
      ...
      <div class="menu">
        ...
        <div class="main">
          <a href="fac_reg.php?id=<?php echo $admin_id; ?>">Add Faculty</a>
            <div class="main2">
                <h2>Faculty</h2>
        
                <input type="text" id="myInput" onkeyup="myFunction()"  class="form-control" placeholder="Search for roll no..." title="Type in a name">
        ...
        ?>
                    ...
                    <tr>
                        ...
                        <td><a href="delete.php?id=<?php echo $row['admin_id'];?>">Delete</a></td>
                    </tr>
                    <?php
                }
            }
